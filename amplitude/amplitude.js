...
var AmplitudeCore = function () {
  ...
  */
		if (_config2.default.active_metadata.live) {
            /*Commented reconnectStream() to resume the audio when it is paused*/
            console.log("Commented reconnectStream() to resume the audio when it is paused");
			//reconnectStream();
		}
  ...
  */
		if (_config2.default.active_metadata.live) {
            /*Commented disconnectStream() to resume the audio when it is paused*/
            console.log("Commented disconnectStream() to resume the audio when it is paused");
			//disconnectStream();
		}
